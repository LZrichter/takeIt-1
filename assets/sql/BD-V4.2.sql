...
CREATE TABLE IF NOT EXISTS `takeit`.`usuario` (
  ...
  `usuario_nivel` ENUM('Admin', 'Pessoa', 'Instituicao') NOT NULL DEFAULT 'Pessoa',
...
CREATE TABLE IF NOT EXISTS `takeit`.`denuncia` (
  ...
  `denuncia_status` ENUM('Aberta', 'Ignorada', 'Resolvida') NULL,
...
VALUES ('Acessórios para Veículos'), ('Agro, Indústria e Comércio'), ('Animais'), ('Antiguidades'), ('Arte e Artesanato'), ('Bebês'), ('Brinquedos e Hobbies'), ('Calçados e Roupas'), ('Casa, Móveis e Decoração'), ('Celulares e Telefones'), ('Coleções e Comics'), ('Eletrodomésticos'), ('Eletrônicos, Áudio e Vídeo'), ('Esporte e Fitness'), ('Ferramentas e Construção'), ('Filmes e Seriados'), ('Games'), ('Informática'), ('Ingressos'), ('Instrumentos Musicais'), ('Jóias e Relógios'), ('Livros'), ('Música'), ('Saúde e Beleza');

-- -----------------------------------------------------
-- INSERÇÃO DE ESTADOS E CIDADES
-- -----------------------------------------------------
INSERT INTO `estado` (`estado_uf`)
VALUES ('AC'), ('AL'), ('AM'), ('AP'), ('BA'), ('CE'), ('DF'), ('ES'), ('GO'), ('MA'), ('MG'), ('MS'), ('MT'), ('PA'), ('PB'), ('PE'), ('PI'), ('PR'), ('RJ'), ('RN'), ('RO'), ('RR'), ('RS'), ('SC'), ('SE'), ('SP'), ('TO');

INSERT INTO `cidade` (`cidade_nome`, `estado_id`) VALUES
( 'Afonso Cláudio', 8),
