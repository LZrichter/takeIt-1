			...
			<div class="panel-body">
									...
									<div class="col-sm-9 col-md-8 text-center left-recebidos">
										<div class="photo"> 
				   	    				...
				   	    				<div class="text-left">
				   	    					...
				   	    					<? echo(isset($qualTela) && $qualTela == 4 ? $busca_item[$i]["doacao_qtde"] : $busca_item[$i]["item_qtde"]) ?>
				   	    					</p>
				   	    					<p><strong>Data: </strong>
			   	    						<?
			   	    						$data = (isset($qualTela) && $qualTela == 4 ? $busca_item[$i]["doacao_data"] : $busca_item[$i]["item_data"]);
									...
									<div class=" col-sm-3 col-md-4 text-center right-recebidos">
										<div class="btn-group">
											...
											<p class="btn-group-vertical">
												...
												<a href="/chat/<?= arrumaString($busca_item[$i]["item_descricao"]) . "-" . $busca_item[$i]['item_id']; ?>" class="btn btn-primary"><i class="fa fa-comments-o"></i> Abrir Chat</a>
											</p>
										</div>
									</div>
				...
				<?else:?>
					<div class="alert alert-warning text-center">
						<div class="row">
							<div class="col-md-6 col-md-offset-3"><h3>Ops! Você ainda não tem nenhuma doação por aqui. <span class="fa fa-frown-o"></span></h3>					
							</div>
						</div>
					</div>
				<? endif;?>
